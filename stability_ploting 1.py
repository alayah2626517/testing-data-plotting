...
def run_app():
    ...
    label_frame.pack(padx=15, pady=10, fill="x")
    ...
    label_frame_2.pack(padx=10, pady=10, fill="x")
    ...
    file_path = None
    tk.Button(label_frame_2, text="Select file", command=select_file).grid(row=1, column=0, padx=25, pady=10)
    ...
    label_frame_3.pack(padx=10, pady=10, fill="x")
