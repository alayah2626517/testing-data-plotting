...
def run_app():
    ...
    tk.Label(label_frame_2, text="Select the file: ", font=('Arial', 12), bg="DarkOliveGreen2").grid(row=0, column=0, padx=66, pady=5)
    tk.Label(label_frame_2, text="Beware of the datasets layout!", font=('Arial', 12, 'bold'), bg="DarkOliveGreen2").grid(row=1, column=0, padx=66, pady=5)
    file_path = None
