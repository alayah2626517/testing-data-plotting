...
def run_app():
    ...
    # 輸入框: Batch
    label_frame = tk.LabelFrame(root, text="Step 1", width=380, bg="light blue", bd=10, relief='groove')
    label_frame.pack(padx=10, pady=10, fill="both", expand=True)
    tk.Label(label_frame, text="Maximmum # of Batch ?", font=('Arial', 14, 'bold'), bg="light blue").grid(row=0, column=1, padx=20, pady=20)
